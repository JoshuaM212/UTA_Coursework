...
module riscv_top (
    ...
    wire        wb_ex_wb_enable;
    wire [4:0]  wb_ex_wb_reg;
    wire [31:0] wb_ex_wb_data;
	...
	// extra line, ignore
    .probe21(mem_wb_wb_enable), // input wire [0:0]  probe21 
	.probe22(wb_ex_wb_enable), // input wire [0:0]  probe22 
	.probe23(wb_ex_wb_reg), // input wire [4:0]  probe23 
	.probe24(wb_ex_wb_data), // input wire [31:0]  probe24 
	.probe25(ebreak), // input wire [0:0]  probe25 
	.probe26(id_regs_rs2_data) // input wire [31:0]  probe26
    );
    ...
    .wb_enable(wb_ex_wb_enable),    // from wb
    .wb_reg(wb_ex_wb_reg),           // from wb
    .wb_data(wb_ex_wb_data),        // from wb
    ...
    .regif_wb_enable(wb_ex_wb_enable),  // register interface
    .regif_wb_reg(wb_ex_wb_reg),        // register interface
    .regif_wb_data(wb_ex_wb_data),      // register interface
    .ebreak(ebreak)                     // TEMPORARY STOP CONIDITION 
    );
endmodule