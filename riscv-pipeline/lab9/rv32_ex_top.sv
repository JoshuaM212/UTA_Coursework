...
module rv32_ex_top (
    ...
    input [4:0] rs1_reg_in,             // new wire for lab 9
    input [4:0] rs2_reg_in,             // new wire for lab 9
    // to mem
    ...
    output df_wb_from_mem_ex,          // new wire for lab 9
    // data hazard: df from mem to wb
    ...
    assign df_wb_from_mem_ex = wb_from_mem_in;

    // Data Hazard Handler
    wire [31:0] rs1_df_alu_in = (df_wb_from_mem_wb && (rs1_reg_in == df_wb_reg)) ? df_wb_data : rs1_data_in;
    wire [31:0] rs2_df_alu_in = (df_wb_from_mem_wb && (rs2_reg_in == df_wb_reg)) ? df_wb_data : rs2_data_in;
    ...
    .rs1_data_in(rs1_df_alu_in),    // register 1 received
    .rs2_data_in(rs2_df_alu_in),    // register 2 received
